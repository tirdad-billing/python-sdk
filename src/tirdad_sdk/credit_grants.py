...
class CreditGrants(BaseSDK):
    def get_addon_credit_grants(
        ...
        *,
        ...
        request = models.GetAddonCreditGrantsRequest(
            id=id,
        )

        req = self._build_request(
            method="GET",
            path="/addons/{id}/creditgrants",
            base_url=base_url,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="getAddonCreditGrants",
                oauth2_scopes=None,
    ...
    async def get_addon_credit_grants_async(
        self,
        *,
        id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
