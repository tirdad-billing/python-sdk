...
class Workflows(BaseSDK):
    def query_workflow(
        ...
        *,
        ...
        order: Optional[models.WorkflowExecutionFilterOrder] = None,
        sort: Optional[
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", models.WorkflowExecutionFilter
            ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.ListWorkflowsResponse, http_res)
