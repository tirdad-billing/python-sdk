...
class Customers(BaseSDK):
    ...
    def get_subscriptions_for_customer(
        ...
        *,
        ...
        r"""Get subscriptions for customer by external ID
        ...
        :param external_id: Customer External ID
        :param expand: Comma-separated fields to expand: subscription_line_items, subscription_line_items.meters, entitlements, plan, customer
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
        ...
        request = models.GetSubscriptionsForCustomerRequest(
            external_id=external_id,
            expand=expand,
        )
        ...
        req = self._build_request(
            method="GET",
            path="/customers/external/{external_id}/subscriptions",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="getSubscriptionsForCustomer",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
                tags=["Customers"],
    ...
    async def get_subscriptions_for_customer_async(
        self,
        *,
        external_id: str,
        expand: Optional[str] = None,
