...
class ListCostsheetResponseTypedDict(TypedDict):
    items: NotRequired[List[CostsheetResponseTypedDict]]
    pagination: NotRequired[PaginationResponseTypedDict]


class ListCostsheetResponse(BaseModel):
    items: Optional[List[CostsheetResponse]] = None
