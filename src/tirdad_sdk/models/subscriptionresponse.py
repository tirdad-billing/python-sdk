...
class SubscriptionResponseTypedDict(TypedDict):
    ...
    entitlements: NotRequired[List[AggregatedFeatureTypedDict]]
    r"""Entitlements is populated only when the caller adds \"entitlements\" to
...
class SubscriptionResponse(BaseModel):
    ...
    entitlements: Optional[List[AggregatedFeature]] = None
    r"""Entitlements is populated only when the caller adds \"entitlements\" to
    the search filter's expand string. Each entry is a feature with its
    aggregated entitlement info (same shape as CustomerEntitlementsResponse.Features).
    """
