...
class ListUsageRecordsResponseTypedDict(TypedDict):
    items: NotRequired[List[UsageRecordResponseTypedDict]]
    pagination: NotRequired[PaginationResponseTypedDict]


class ListUsageRecordsResponse(BaseModel):
    items: Optional[List[UsageRecordResponse]] = None
