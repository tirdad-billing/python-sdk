...
class WebhookDtoTransactionUpdatedWebhookPayloadTypedDict(TypedDict):
    ...
    updated_transaction: NotRequired[WalletTransactionResponseTypedDict]
...
class WebhookDtoTransactionUpdatedWebhookPayload(BaseModel):
    ...
    updated_transaction: Optional[WalletTransactionResponse] = None
    ...
    def serialize_model(self, handler):
        optional_fields = set(
            ["customer", "event_type", "updated_transaction", "wallet"]
        )
