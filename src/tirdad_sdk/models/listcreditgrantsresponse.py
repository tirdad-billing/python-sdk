...
class ListCreditGrantsResponseTypedDict(TypedDict):
    items: NotRequired[List[CreditGrantResponseTypedDict]]
    pagination: NotRequired[PaginationResponseTypedDict]


class ListCreditGrantsResponse(BaseModel):
    items: Optional[List[CreditGrantResponse]] = None
