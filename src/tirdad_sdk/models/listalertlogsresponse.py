...
class ListAlertLogsResponseTypedDict(TypedDict):
    items: NotRequired[List[AlertLogResponseTypedDict]]
    pagination: NotRequired[PaginationResponseTypedDict]


class ListAlertLogsResponse(BaseModel):
    items: Optional[List[AlertLogResponse]] = None
