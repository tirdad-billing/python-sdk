...
from .workflowexecutiondto import WorkflowExecutionDTO, WorkflowExecutionDTOTypedDict
...
class ListWorkflowsResponseTypedDict(TypedDict):
    items: NotRequired[List[WorkflowExecutionDTOTypedDict]]
    pagination: NotRequired[PaginationResponseTypedDict]


class ListWorkflowsResponse(BaseModel):
    items: Optional[List[WorkflowExecutionDTO]] = None
