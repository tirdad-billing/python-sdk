...
class WebhookDtoSubscriptionWebhookPayloadTypedDict(TypedDict):
...
class WebhookDtoSubscriptionWebhookPayload(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = set(["customer", "event_type", "subscription"])
