...
class WebhookDtoTransactionWebhookPayloadTypedDict(TypedDict):
    ...
    transaction: NotRequired[WebhookDtoWalletTransactionTypedDict]


class WebhookDtoTransactionWebhookPayload(BaseModel):
    event_type: Optional[WebhookEventName] = None

    transaction: Optional[WebhookDtoWalletTransaction] = None

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = set(["event_type", "transaction"])
