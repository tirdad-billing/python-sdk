...
class ListPriceUnitsResponseTypedDict(TypedDict):
    items: NotRequired[List[PriceUnitResponseTypedDict]]
    pagination: NotRequired[PaginationResponseTypedDict]


class ListPriceUnitsResponse(BaseModel):
    items: Optional[List[PriceUnitResponse]] = None
