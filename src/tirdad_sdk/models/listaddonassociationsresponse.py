...
class ListAddonAssociationsResponseTypedDict(TypedDict):
    items: NotRequired[List[AddonAssociationResponseTypedDict]]
    pagination: NotRequired[PaginationResponseTypedDict]


class ListAddonAssociationsResponse(BaseModel):
    items: Optional[List[AddonAssociationResponse]] = None
