...
class ListCouponAssociationsResponseTypedDict(TypedDict):
    items: NotRequired[List[CouponAssociationResponseTypedDict]]
    pagination: NotRequired[PaginationResponseTypedDict]


class ListCouponAssociationsResponse(BaseModel):
    items: Optional[List[CouponAssociationResponse]] = None
