...
class IntegrationConfigResponseTypedDict(TypedDict):
    integrations: NotRequired[List[IntegrationConfigEntryTypedDict]]


class IntegrationConfigResponse(BaseModel):
    integrations: Optional[List[IntegrationConfigEntry]] = None
