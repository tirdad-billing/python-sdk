...
class Invoices(BaseSDK):
        ...
        *,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                security_source=self.sdk_configuration.security,
                tags=["Invoices"],
                extensions={"x-codegen-request-body-name": "invoice"},
            ),
            request=req,
            is_error_status_code=lambda c: utils.match_status_codes(["4XX", "5XX"], c),
            retry_config=retry_config,
    ...
    def execute_invoice_modify(
        self,
        *,
        id: str,
        type_: models.InvoiceModifyType,
        line_item_params: Optional[
            Union[
                models.InvoiceModifyLineItemParams,
                models.InvoiceModifyLineItemParamsTypedDict,
            ]
        ] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        ...
        r"""Execute invoice modification
        ...
        request = models.ExecuteInvoiceModifyRequestRequest(
            id=id,
            body=models.ExecuteInvoiceModifyRequest(
                line_item_params=utils.get_pydantic_model(
                    line_item_params, Optional[models.InvoiceModifyLineItemParams]
                ),
                type=type_,
            ),
        )
        ...
        req = self._build_request(
            method="POST",
            path="/invoices/{id}/modify/execute",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=True,
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.body, False, False, "json", models.ExecuteInvoiceModifyRequest
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="executeInvoiceModify",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
                tags=["Invoices"],
                extensions={
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.InvoiceModifyResponse, http_res)
        if utils.match_response(http_res, ["400", "404"], "application/json"):
            response_data = unmarshal_json_response(
                models.errors.ErrorResponseData, http_res
            )
    ...
    async def execute_invoice_modify_async(
        self,
        *,
        id: str,
        type_: models.InvoiceModifyType,
