...
class TaxAssociations(BaseSDK):
    ...
    def create_tax_association(
        ...
        *,
        ...
        :param auto_apply:
        :param currency:
        :param end_date: EndDate sets when this association expires. Must be after StartDate when both are provided.
        :param entity_id:
        :param entity_type:
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                security_source=self.sdk_configuration.security,
                tags=["Tax Associations"],
                extensions={"x-codegen-request-body-name": "tax_config"},
            ),
            request=req,
            is_error_status_code=lambda c: utils.match_status_codes(["4XX", "5XX"], c),
            retry_config=retry_config,
