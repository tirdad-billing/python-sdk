...
| `is_tirdad_managed`                                                 | *Optional[bool]*                                                       | :heavy_minus_sign:                                                     | If true, use Tirdad-managed S3 credentials instead of user-provided |
| `key_prefix`                                                           | *Optional[str]*                                                        | :heavy_minus_sign:                                                     | Optional prefix for S3 keys (e.g., "tirdad-exports/")               |
