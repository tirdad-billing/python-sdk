...
with Tirdad(
    ...
    res = tirdad.integrations.link_integration_mapping(entity_id="<id>", entity_type="invoice_line_item", provider_entity_id="<id>", provider_type="<value>")
...
with Tirdad(
    ...
    res = tirdad.integrations.delink_integration_mapping(entity_id="<id>", entity_type="price", provider_type="<value>")
