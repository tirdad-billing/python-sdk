...
with Tirdad(
    ...
    res = tirdad.subscriptions.create_subscription(billing_period="DAILY", currency="New Leu", plan_id="<id>")
...
with Tirdad(
    ...
    res = tirdad.subscriptions.activate_subscription(id="<id>", start_date=parse_datetime("<value>"))
...
with Tirdad(
    ...
    res = tirdad.subscriptions.execute_subscription_change(id="<id>", billing_cadence="RECURRING", billing_cycle="anniversary", billing_period="QUARTERLY", proration_behavior="create_prorations", target_plan_id="<id>")
...
with Tirdad(
    ...
    res = tirdad.subscriptions.preview_subscription_change(id="<id>", billing_cadence="RECURRING", billing_cycle="calendar", billing_period="HALF_YEARLY", proration_behavior="create_prorations", target_plan_id="<id>")
...
with Tirdad(
    ...
    res = tirdad.subscriptions.preview_subscription_modify(id="<id>", type_="grouped_invoicing")
