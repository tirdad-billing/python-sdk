...
| `contact`                                                                                                   | *Optional[str]*                                                                                             | :heavy_minus_sign:                                                                                          | contact is the updated contact number for the customer (e.g. phone)                                         |
...
| `tax_treatment`                                                                                             | [Optional[models.TaxTreatment]](../../models/taxtreatment.md)                                               | :heavy_minus_sign:                                                                                          | N/A                                                                                                         |
...
| `contact`                                                                                                                                                                                                     | *Optional[str]*                                                                                                                                                                                               | :heavy_minus_sign:                                                                                                                                                                                            | contact is an optional contact number for the customer (e.g. phone)                                                                                                                                           |
...
| `onboarding_workflow_name`                                                                                                                                                                                    | *Optional[str]*                                                                                                                                                                                               | :heavy_minus_sign:                                                                                                                                                                                            | onboarding_workflow_name is given if a custom onboarding workflow is to be triggered for this customer                                                                                                        |
